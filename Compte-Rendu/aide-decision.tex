...
%\begin{description}
%\item[Figure :]  Une figure peut être un cercle, un rectangle, une ligne, une polyligne ou un agrégat. L’agrégat est composé d’autant de figures que l’ont veut et celles-ci peuvent aussi être des agrégats.
%\item[Point :] Une  structure Point est définie, elle contient les coordonnées x et y d’un point sous forme de longs.
%\end{description}

%\subsection{Choix Généraux}
%\begin{itemize}
%\item La caste est importante autant pour les noms que pour les commandes. Une commande invalide générera une réponse ERR.
%\end{itemize}
%
% 
%\subsection{Détail des fonctionnalités et choix spécifiques}
%\subsubsection{Création d'une figure}
%\begin{description}
%\item[Cercle :] {\tt C Name X1 Y1 R }, avec Name son nom, X1,Y1 les coordonnées de son centre et R son rayon. Le rayon doit être supérieur ou égal à 0. Le nom doit être composé de lettres et de chiffres, les autres paramètres sont des long. Un nom ne peut pas être composé de plusieurs mots.
%\end{description}
