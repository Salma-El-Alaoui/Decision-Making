...
\end{equation*}
\begin{align*}
\textbf{Usage minimal de la machine 3 en min = 1178.8}
\textbf{Usage de la machine 5 correspondant à ce plan = 1003.8}
\end{align*}
Satisfaction des contraintes : 
\begin{align*}
...
\end{equation*}
\begin{align*}
\textbf{Usage minimal de la machine 5 en min = 785}
\textbf{Usage de la machine 3 correspondant à ce plan = 2104}
\end{align*}
